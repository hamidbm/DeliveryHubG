...
declare global {
  ...
  interface Window {
    // Fix: Removed readonly modifier to ensure matching modifiers with platform declarations and resolve "All declarations of 'aistudio' must have identical modifiers" error on line 25.
    aistudio: AIStudio;
  }
}
