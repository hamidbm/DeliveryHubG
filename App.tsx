...
declare global {
  ...
  interface Window {
    // Fix: Added readonly modifier to match the platform's injected property definition and resolve "All declarations of 'aistudio' must have identical modifiers" error.
