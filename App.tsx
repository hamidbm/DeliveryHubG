...
declare global {
  ...
  interface Window {
    // Added readonly modifier to resolve "All declarations of 'aistudio' must have identical modifiers" error.
    // This matches the environment's internal global declaration of the aistudio object.
